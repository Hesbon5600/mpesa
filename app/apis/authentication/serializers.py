...
from ..helpers.token import generate_password_reset_token
...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['first_name', 'last_name', 'email',
                  'password', 'phone_number', 'image', 'token']
...
class UserRetrieUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        exclude = ('last_login', 'is_superuser', 'deleted', 'is_active',
